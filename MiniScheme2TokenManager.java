/* Generated By:JavaCC: Do not edit this line. MiniScheme2TokenManager.java */
import java.util.Scanner;
import java.io.FileInputStream;
import java.io.FileNotFoundException;

/** Token Manager. */
public class MiniScheme2TokenManager implements MiniScheme2Constants
{
...
static private int jjMoveStringLiteralDfa1_0(long active0)
{
   ...
   {
      case 101:
         return jjMoveStringLiteralDfa2_0(active0, 0x1e800L);
      case 114:
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 1:
                  ...
                  break;
               case 2:
                  if ((0xf7ffec7200000000L & l) != 0L && kind > 19)
                     kind = 19;
                  break;
               case 3:
                  if ((0xf400847200000000L & l) == 0L)
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               case 0:
                  ...
                  break;
               case 2:
                  if ((0x47fffffec0000001L & l) != 0L && kind > 19)
                     kind = 19;
                  break;
               case 3:
                  if ((0x47fffffec0000000L & l) == 0L)
...
"\161\165\157\164\151\145\156\164", null, null, "\162\145\141\144", "\167\162\151\164\145", 
"\156\145\167\154\151\156\145", "\144\145\146\151\156\145", "\154\145\164", "\163\145\164\41", null, null, 
null, "\50", "\51", };
...
/** Constructor. */
public MiniScheme2TokenManager(SimpleCharStream stream){
...
/** Constructor. */
public MiniScheme2TokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
